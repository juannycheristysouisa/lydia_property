...
<body>
    <nav class="navbar navbar-admin">
        <div class="navbar-brand">
            <i class="fas fa-cogs"></i> Admin Panel - Property Villa & Apartemen
        </div>
        <div class="nav-right">
            <a href="{{ route('admin.dashboard') }}" class="nav-link"><i class="fas fa-tachometer-alt"></i>
                Dashboard</a>
            <a href="{{ route('admin.properties.index') }}" class="nav-link"><i class="fas fa-building"></i>
                Properti</a>
            <a href="{{ route('admin.bookings.index') }}" class="nav-link"><i class="fas fa-calendar-check"></i>
                Pemesanan</a>
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <div class="card-admin" data-sr>
                    ...
                    <a href="{{ route('admin.properties.create') }}" class="btn btn-primary-admin btn-admin me-2"><i
                            class="fas fa-plus"></i> Tambah Properti</a>
                    <a href="{{ route('admin.bookings.index') }}" class="btn btn-success-admin btn-admin"><i
                            class="fas fa-eye"></i> Lihat Laporan</a>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card-admin" data-sr>
